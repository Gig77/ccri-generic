...
#opt <- data.frame('sample-id' = "839R", 'tumor-coverage' = "coverage-genome/839R.coverage-genome.tsv", 'normal-coverage' = "coverage-genome/839C.coverage-genome.tsv", 'tumor-vcf' = "varscan/839R.varscan.dbsnp.vcf", 'normal-vcf' = "varscan/839C.varscan.dbsnp.vcf", 'plot-output-file' = "snp-profile/839R.snp-profile.pdf", 'loh-segments-output-file' = "snp-profile/839R.loh-segments.tsv", stringsAsFactors=F, check.names=F)   
